...
router.post("/", (req, res, next) => {
    ...
    next();
}, auth_middleware_1.TokenVerification, (0, reqValidator_middleware_1.default)(voucher_schema_1.CreateVoucherSchema), voucher_controller_1.CreateVoucherController);
